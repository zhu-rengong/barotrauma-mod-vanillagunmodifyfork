namespace AutoGenerateXML
{
    ...
    {
        public static readonly string VGM_Accessory = nameof(VGM_Accessory);
        public static readonly string VGM_Scanner = nameof(VGM_Scanner);
        public static readonly string VGM_Stock = nameof(VGM_Stock);
        public static readonly string VGM_Grip = nameof(VGM_Grip);
