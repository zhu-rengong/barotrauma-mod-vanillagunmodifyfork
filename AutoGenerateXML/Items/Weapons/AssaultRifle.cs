...
{
    public class AssaultRifle : GunXMLGenerator
    {
        public override string OutputPath => Path.Combine("Guns", $@"{GunName}.xml");

        public override string GunName => nameof(AssaultRifle);

        public override string Identifier => Identifiers.VGM_AssaultRifle;
        public override string SelfTags => "mediumitem,weapon,gun,gunsmith,mountableweapon,provocativetohumanai,assaultrifle";
        ...
        public override ContainableStock[] CompatibleStocks => [
            new(Identifiers.VGM_AssaultRifleStock, ItemPos: [-45,3]),
            new(Identifiers.VGM_HeavyStock, ItemPos: [-46,1]),
            new(Identifiers.VGM_HeavySniperStock, ItemPos: [-49,3]),
        ];
        ...
        public override ContainableAimingDevice[] CompatibleAimingDevices => [
            new(Identifiers.VGM_RedDotSight, ItemPos: [-14,17]),
            new(Identifiers.VGM_HolographicSight, ItemPos: [-13,17]),
            new(Identifiers.VGM_ACOGScope, ItemPos: [-17,20]),
            new(Identifiers.VGM_RifleScope, ItemPos: [-14,16]),
