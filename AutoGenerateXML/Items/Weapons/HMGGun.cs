...
<Item {GenerateGunXMLAttributesString()} cargocontaineridentifier=""metalcrate"" impactsoundtag=""impact_metal_light"">
    ...
    <Wearable slots=""Bag"" canbeselected=""false"" canbepicked=""true"" pickkey=""Select"" msg=""ItemMsgEquipSelect"">
      <sprite name=""{Name.FollowedByModPrefix()} Worn"" texture=""%ModDir%/EuropaArmedGroupCommunity/VanillaGunModify/Guns/Guns.png"" canbehiddenbyotherwearables=""false"" rotation=""90"" depth=""0.6"" sourcerect=""0,480,178,71"" limb=""Torso"" depthlimb=""LeftArm"" scale=""{Scale}"" origin=""0.5,0.8"" />
    </Wearable>
