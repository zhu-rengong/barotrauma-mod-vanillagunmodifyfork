...
{
    public class HMG : GunXMLGenerator
    {
        public override string OutputPath => Path.Combine("Guns", $@"{GunName}.xml");

        public override string GunName => nameof(HMG);

        public override string Identifier => Identifiers.VGM_HMG;
        public override string SelfTags => "mediumitem,weapon,gun,gunsmith,provocativetohumanai,mountableweapon,hmg";
        ...
        public override ContainableGrip[] CompatibleGrips => [
            new(Identifiers.VGM_AngledForeGrip, ItemPos: [14,-2]),
            new(Identifiers.VGM_VerticalGrip, ItemPos: [14,-5]),
            new(Identifiers.VGM_BipodGrip, ItemPos: [15,-12]),
        ];

        public override ContainableStock[] CompatibleStocks => [
            new(Identifiers.VGM_HMGStock, ItemPos: [-48,2]),
            new(Identifiers.VGM_HeavyStock, ItemPos: [-47,2]),
            new(Identifiers.VGM_HeavySniperStock, ItemPos: [-52,3]),
        ];
        ...
        public override ContainableAimingDevice[] CompatibleAimingDevices => [
            new(Identifiers.VGM_RedDotSight, ItemPos: [-5,20]),
            new(Identifiers.VGM_HolographicSight, ItemPos: [-3,22]),
            new(Identifiers.VGM_ACOGScope, ItemPos: [-4,23]),
            new(Identifiers.VGM_RifleScope, ItemPos: [-13,20]),
            new(Identifiers.VGM_SniperScope, ItemPos: [1,23]),
        ];

        public override ContainableScanner[] CompatibleScanners => [
            new(Identifiers.VGM_HealthScanner, ItemPos: [8,16]),
            new(Identifiers.VGM_ThermalScanner, ItemPos: [8,16]),
        ];
