...
{
    public class ShotgunUniqueGun : GunXMLGenerator
    {
        public ShotgunUniqueGun() : base()
        {
            Name = "ShotgunUnique";
            OutputPath = Path.Combine("Guns", $@"{Name}.xml");
            Identifier = Identifiers.VGM_ShotgunUnique;

            SelfTags.AddRange(["mediumitem", Name]);
        ...
        public override List<ContainableGrip> ContainableGrips => [
            new(GripXMLGenerator.All[Identifiers.VGM_AngledForeGrip], ItemPos: [11,-6]),
            new(GripXMLGenerator.All[Identifiers.VGM_VerticalGrip], ItemPos: [17,-6]),
        ];
        ...
        public override List<ContainableStock> ContainableStocks => [
            new(StockXMLGenerator.All[Identifiers.VGM_ShotgunUniqueStock], ItemPos: [-40,-7]),
            new(StockXMLGenerator.All[Identifiers.VGM_LightStock], ItemPos: [-45,-6]),
            new(StockXMLGenerator.All[Identifiers.VGM_LightSniperStock], ItemPos: [-45,-6]),
            new(StockXMLGenerator.All[Identifiers.VGM_LightWrenchStock], ItemPos: [-47,-8]),
        ];
